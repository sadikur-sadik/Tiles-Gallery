...
const Card = (tile) => {
  ...
  return (
    <div className="bg-white border-b-3 border-b-blue-700 hover:scale-101 duration-200 shadow-md hover:shadow-2xl rounded-xl p-6 max-w-80 flex flex-col justify-between">
